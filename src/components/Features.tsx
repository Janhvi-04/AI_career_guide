    ...
    <section id="features" className="relative py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center max-w-2xl mx-auto">
          <div className="text-sm font-medium text-accent uppercase tracking-widest">Features</div>
          <h2 className="mt-3 text-4xl md:text-5xl font-bold">
            Everything you need to <span className="text-gradient">build your future</span>
          </h2>
        </div>
        ...
        <div className="mt-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {features.map((f, i) => (
            ...
            >
              ...
              <div className={`relative inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${f.color} glow-violet`}>
